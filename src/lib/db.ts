...
const mem: MemStore = (g.__sjxMem ??= {
  ...
  news: [
    {
      id: 1,
      title: "Welcome to the new Finnair Virtual",
      body: "We've rebuilt the website from the ground up — a live flight map, a full PIREP system, the leaderboard, and this news feed. Thanks for flying with us. The Nordic Way to Fly. ✦",
