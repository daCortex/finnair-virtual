      ...
      <div className="sticky top-16 z-10 -mx-1 mb-5 rounded-2xl border border-obsidian glass p-3">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center">
          <div className="relative flex-1">
            ...
            <input value={q} onChange={(e) => setQ(e.target.value)} placeholder="Find a flight — AY15, Tokyo, EFHK, Helsinki…"
          ...
          <div key={r.routeNumber} className="group rounded-2xl border border-obsidian bg-ink-900 p-4 lift">
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-1.5">
                ...
                {r.airline !== "Finnair" && <span className="rounded-full bg-ink-800 px-2 py-0.5 text-[0.6rem] uppercase text-cream-faint">{r.airline}</span>}
              </div>
