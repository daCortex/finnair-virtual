...
const PLANNED = [
  { title: "Tune AP & LC payouts", body: "Adjust the net Aurora-Points / Logistics-Credits per flight category and risk band without a redeploy." },
    ...
    <section className="mx-auto max-w-5xl px-6 py-10 lg:px-10">
      ...
      <div className="mt-7 grid gap-5 md:grid-cols-2">
        <div className="rounded-2xl border border-obsidian bg-ink-900 p-6">
          <h3 className="font-display text-base font-semibold text-cream">Career · Aurora Points (live)</h3>
