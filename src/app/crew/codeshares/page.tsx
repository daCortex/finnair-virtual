...
export default function CrewCodesharesPage() {
  ...
  return (
    <section className="mx-auto max-w-5xl px-6 py-10 lg:px-10">
      ...
      <p className="mt-1 text-sm text-cream-dim">Add partner routes to the network. They flow straight into the pilot route database, the flight finder and oneworld Discover.</p>
      <div className="mt-6">
