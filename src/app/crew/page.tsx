...
export default async function CrewDashboard() {
  ...
  const cards = [
    { label: "Active pilots", value: String(s.activePilots), href: "/crew/pilots" },
    { label: "Pending applications", value: String(s.pendingPilots), href: "/crew/applications", alert: s.pendingPilots > 0 },
    { label: "PIREPs to review", value: String(s.pendingPireps), href: "/crew/pireps", alert: s.pendingPireps > 0 },
    { label: "Hours flown", value: formatDuration(s.totalMinutes), href: "/crew/pilots" },
  ];
