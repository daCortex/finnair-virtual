...
export default function MapPage() {
  ...
  for (const r of ROUTES) {
    ...
    for (const code of [r.dep, r.arr]) {
      if (code === "EFHK" || seen.has(code)) continue;
    ...
    <div className="mx-auto max-w-7xl px-5 py-10 lg:px-8">
      <header className="rise mb-5 flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="mt-2 max-w-xl text-cream-dim">The Finnair Virtual network radiating from Helsinki, with live Infinite Flight traffic overlaid in real time.</p>
        </div>
