          ...
          <div className="grid gap-10 md:grid-cols-[1.4fr_1fr]">
            <div>
              <div className="flex items-center gap-2.5">
                <Image src="/brand/finnair-emblem-navy.png" alt="" width={1050} height={590} className="logo-light-theme h-5 w-auto" />
                <Image src="/brand/finnair-emblem-white.png" alt="" width={510} height={287} className="logo-dark-theme h-5 w-auto" />
              ...
              <Link href="/join" className="mt-6 inline-flex items-center gap-2 rounded-full bg-gold px-5 py-2.5 text-sm font-medium text-white transition-all hover:brightness-125">Apply to Finnair Virtual <span aria-hidden>→</span></Link>
            </div>
            <div>
