    ...
    <div>
      ...
      <section className="mx-auto max-w-7xl px-5 pb-24 lg:px-8">
        <div className="aurora flex flex-col items-center gap-5 rounded-3xl px-6 py-14 text-center">
          <h2 className="font-display text-3xl font-semibold text-white lg:text-4xl">Your career starts at Aurora.</h2>
          <p className="max-w-md text-white/70">Join a community of pilots committed to realism, excellence, and Nordic precision.</p>
          <Link href="/join" className="rounded-full bg-white px-7 py-3 text-sm font-semibold text-fin-blue transition-transform hover:scale-[1.03]">Apply to Finnair Virtual</Link>
        </div>
      </section>
    </div>
  );
