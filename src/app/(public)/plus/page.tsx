  ...
  return (
    <div className="mx-auto max-w-6xl px-5 py-16 lg:px-8 lg:py-20">
      <header className="reveal">
        ...
        <p className="lead mt-4 max-w-2xl text-cream-dim">Finnair Plus is a private economy for our pilots. Earn Aurora Points (AP) on every Career-mode flight and climb five tiers — each milestone a recognition of your dedication to the airline.</p>
      </header>
