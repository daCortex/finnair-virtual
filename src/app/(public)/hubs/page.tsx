  ...
  return (
    <div className="mx-auto max-w-6xl px-5 py-16 lg:px-8 lg:py-20">
      <header className="reveal">
        ...
        <p className="mt-4 max-w-2xl text-cream-dim">Finnair Virtual is built around Helsinki-Vantaa, with focus cities that feed the trunk network and extend reach across Scandinavia.</p>
      </header>
