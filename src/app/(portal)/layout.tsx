      ...
      <footer className="mt-16 border-t border-obsidian bg-ink-900">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 px-5 py-8 lg:flex-row lg:items-center lg:justify-between lg:px-8">
          <div className="flex items-center gap-3 text-sm">
            <span className="font-semibold text-cream">Finnair Virtual</span>
          ...
          <div className="flex flex-wrap items-center gap-x-5 gap-y-1 text-xs text-cream-faint">
            <Link href="/ranks" className="hover:text-cream">Ranks</Link>
            <Link href="/routes" className="hover:text-cream">Routes</Link>
            <Link href="/leaderboard" className="hover:text-cream">Leaderboard</Link>
            <Link href="/crew" className="hover:text-cream">Crew Center</Link>
          </div>
        </div>
